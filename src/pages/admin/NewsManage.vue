          ...
          <q-form v-model='form.valid' @submit.prevent='submitForm'>
            <q-card flat>
              ...
              <div class="row">
                ...
                <div class="col" col="6">
                  <div class="col" col="6">
                    <q-file v-model="form.image" rounded standout counter :label="$t('公告圖片')"></q-file>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col" col="12">
                  <q-input v-model="form.description" rounded standout label="公告內容" autogrow type="textarea" />
                </div>
              </div>
